Attribute VB_Name = "Module2_Styles"
'=============================================================================
...
Sub Style_10_Clean_And_Realign_Heading_Structures()
    ...
    Set levelRegex = CreateObject("VBScript.RegExp")
    With levelRegex
        .Global = True
        .Pattern = "\d+"
    End With
        ...
        If Not para.Range.Information(wdWithInTable) Then
            ...
            If Len(Trim$(paraText)) > 0 Then
                ...
                If regex.Test(paraText) Then
                    ...
                    calculatedLevel = levelRegex.Execute(matchStr).Count
                    
                    If calculatedLevel < 1 Then calculatedLevel = 1
                    If calculatedLevel > 9 Then calculatedLevel = 9
                    
                    txtRange.Style = doc.styles(headingStyles(calculatedLevel - 1))
                    
                    cleanText = Mid$(paraText, Len(matchStr) + 1)
...
CleanUp:
    Application.ScreenUpdating = True
    MsgBox "Heading structures successfully realigned and manual numbering stripped!", vbInformation, "Process Complete"
    Exit Sub
